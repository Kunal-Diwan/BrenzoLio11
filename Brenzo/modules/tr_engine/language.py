from Brenzo.modules.sql.locales_sql import switch_to_locale, prev_locale
from Brenzo.modules.tr_engine.strings import tld, LANGUAGES
from telegram.ext import CommandHandler
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from Brenzo import dispatcher
from Brenzo.modules.tr_engine.list_locale import list_locales
...
def locale_button(bot, update):
    ...
    lang_match = re.findall(r"en-US|pt|id|ru|ml", query.data)
    if lang_match:
        if lang_match[0]:
