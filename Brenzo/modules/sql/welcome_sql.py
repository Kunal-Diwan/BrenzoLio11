...
from Brenzo.modules.helper_funcs.msg_types import Types
from Brenzo.modules.sql import SESSION, BASE

DEFAULT_WELCOME = "Hello {first}, Welcome to team"
DEFAULT_GOODBYE = "Bye Bye . Nice to meet you"
