...
from Brenzo.modules.helper_funcs.chat_status import user_admin
from Brenzo.modules.helper_funcs.extraction import extract_text
from Brenzo.modules.helper_funcs.filters import CustomFilters
from Brenzo.modules.helper_funcs.misc import build_keyboard
from Brenzo.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from Brenzo.modules.sql import cust_filters_sql as sql

from Brenzo.modules.tr_engine.strings import tld

from Brenzo.modules.connection import connected
...
def __stats__():
    return "675980 filters, across 8678 chats.".format(sql.num_filters(),
                                                 sql.num_chats())
