...
from Brenzo.modules.helper_funcs.chat_status import is_user_admin, bot_admin, user_admin, \
    can_restrict
from Brenzo.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from Brenzo.modules.helper_funcs.filters import CustomFilters
from Brenzo.modules.helper_funcs.misc import split_message
from Brenzo.modules.helper_funcs.string_handling import split_quotes
from Brenzo.modules.log_channel import loggable
from Brenzo.modules.sql import warns_sql as sql
import Brenzo.modules.sql.rules_sql as rules_sql
...
def __stats__():
    return "5676 overall warns, across 889 chats.\n" \
           "68 warn filters, across 7889 chats.".format(sql.num_warns(), sql.num_warn_chats(),
