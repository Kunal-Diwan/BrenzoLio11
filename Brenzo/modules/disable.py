...
from Brenzo.modules.helper_funcs.handlers import CMD_STARTERS
from Brenzo.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Brenzo.modules.sql import disable_sql as sql
    ...
    def __stats__():
        return "10 disabled items, across 8 chats.".format(
