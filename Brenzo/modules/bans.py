...
from Brenzo.modules.helper_funcs.chat_status import bot_admin, user_admin, is_user_ban_protected, can_restrict, \
    is_user_admin, is_user_in_chat
from Brenzo.modules.helper_funcs.extraction import extract_user_and_text
from Brenzo.modules.helper_funcs.string_handling import extract_time
...
def ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if reason:
        ...
        reply += tld(chat.id, "bans_logger_reason", BAN_STICKER).format(reason)
