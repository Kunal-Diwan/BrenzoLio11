...
BRENZO_PIC = "https://telegra.ph/file/4372666cfb14b027bdbf1.jpg"
...
importlib.import_module("Brenzo.modules.tr_engine.language")

for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Brenzo.modules." + module_name)
